...
data_contact <-as_tibble(data_contact)
...
tb_contact_demo <- data_contact %>% select(demographics)
rm(demographics)
...
skim(tb_contact_demo$Date_of_Service_start)
skim(tb_contact_demo$Date_of_Service_end)
...
skim(tb_contact_demo$Length_of_Service)
...
skim(tb_contact_demo$Length_of_Service_bin)
...
skim(as.factor(tb_contact_demo$last_service_era))
...
skim(as.factor(tb_contact_demo_c$last_service_era))
...
skim(as.factor(tb_contact_demo$Highest_Level_of_Education_Completed__c))
...
levels(as.factor(tb_contact_demo_c$Highest_Level_of_Education_Completed__c))
skim(as.factor(tb_contact_demo_c$Highest_Level_of_Education_Completed__c))
...
cleaned_data$Discharge_Type__c[is.na(cleaned_data$Discharge_Type__c)] <- "Blank"
cleaned_data$Race__c[is.na(cleaned_data$Race__c)] <- "Blank"
cleaned_data$Gender__c[is.na(cleaned_data$Gender__c)] <- "Blank"
skim(cleaned_data)


cleaned_data <- cleaned_data %>% mutate_all(as.factor)
...
fwrite(final_data, file = "Data/complete_data_blank.csv")
